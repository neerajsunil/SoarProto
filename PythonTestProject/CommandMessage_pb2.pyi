...
class CommandMessage(_message.Message):
    __slots__ = ["dmb_command", "message_id", "pbb_command", "source", "source_sequence_num", "target"]
    ...
    def __init__(self, source: _Optional[_Union[_CoreProto_pb2.Node, str]] = ..., target: _Optional[_Union[_CoreProto_pb2.Node, str]] = ..., message_id: _Optional[_Union[_CoreProto_pb2.MessageID, str]] = ..., source_sequence_num: _Optional[int] = ..., dmb_command: _Optional[_Union[DMBCommand, _Mapping]] = ..., pbb_command: _Optional[_Union[PBBCommand, _Mapping]] = ...) -> None: ...
...
class PBBCommand(_message.Message):
    ...
    class Command(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
    COMMAND_ENUM_FIELD_NUMBER: _ClassVar[int]
    PMB_CLOSE_MEV: PBBCommand.Command
    PMB_LAST: PBBCommand.Command
    PMB_NONE: PBBCommand.Command
    PMB_OPEN_MEV: PBBCommand.Command
