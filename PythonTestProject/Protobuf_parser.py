...
STRING_TO_PBB_PROTO_COMMAND = {
	...
	"PBB_OPEN_DRAIN": ProtoCmd.PBBCommand.PBB_OPEN_DRAIN,
    "PBB_CLOSE_DRAIN": ProtoCmd.PBBCommand.PBB_CLOSE_DRAIN,
    "PMB_LAST": ProtoCmd.PBBCommand.PMB_LAST,
}

STRING_TO_RCU_PROTO_COMMAND = {
	"RCU_NONE": ProtoCmd.RCUCommand.RCU_NONE,
    "RCU_TARE_LOAD_CELL": ProtoCmd.RCUCommand.RCU_TARE_LOAD_CELL,
    "RCU_CALIBRATE_LOAD_CELL": ProtoCmd.RCUCommand.RCU_CALIBRATE_LOAD_CELL,
