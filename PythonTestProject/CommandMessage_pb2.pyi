...
class CommandMessage(_message.Message):
    __slots__ = ["dmb_command", "message_id", "source", "source_sequence_num", "target"]
    ...
    def __init__(self, source: _Optional[_Union[_Core_pb2.Node, str]] = ..., target: _Optional[_Union[_Core_pb2.Node, str]] = ..., message_id: _Optional[int] = ..., source_sequence_num: _Optional[int] = ..., dmb_command: _Optional[_Union[DMBCommand, _Mapping]] = ...) -> None: ...
...
class PMBCommand(_message.Message):
    ...
    class Command(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
    CLOSE_MEV: PMBCommand.Command
    COMMAND_ENUM_FIELD_NUMBER: _ClassVar[int]
    HEARTBEAT: PMBCommand.Command
    OPEN_MEV: PMBCommand.Command
